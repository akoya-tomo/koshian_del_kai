...
* 追加・変更された機能（KOSHIAN delフォームをポップアップで開く 改）
  ...
  - ![\(New\)](images/new.png "New") スレを閉じたりリロードしても「del送信済み」を記憶  
    スレを閉じたりリロードしてもdelしたレスに「del送信済み」が残ります。ブラウザを閉じるとクリアされます。  
...
* ![\(New\)](images/new.png "New") 閉じたスレを開いたりリロードしたときは「delしたレスを非表示」にしていても以前delしたレスが表示されることがあります。  
